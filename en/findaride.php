					...
					<div class="col-sm-12">
						<form class="form-horizontal" action="findaride.php" method="post">
                            <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-md-12 col-lg-12">
                                                <label for="femaleRadio"class="radio-inline" style= "color:Black" >
                                                    <h4>	<input name="radio" type="radio" id="ride" value="Ride">Ride</h4>
                                                </label>

                                                <label for="Driver" class="radio-inline" style= "color:Black">
                                                    <h4><input name="radio" type="radio" id="driver" value="Driver">Driver </h4>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-6 col-md-12 col-lg-12">
                                        <input name="driver" type="text" class="form-control " placeholder="Driver--Test" >
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="col-sm-6 col-md-12 col-lg-12">
                                        <input name="destination" type="text" class="form-control " placeholder="To..." >
                                    </div>
                                </div>
                                ...
                                if(isset($_POST["search"])) {
                                    ...
                                    $sql = "SELECT u.Firstname, u.Lastname, ct.Seats, ct.DepartureTime, ct.DepartureDate, adr1.Street as DepartureStreet, adr1.City as DepartureCity , adr2.Street, adr2.City
